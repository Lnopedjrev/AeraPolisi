...
from .views import (Shop, favourite,
                    SupposeProduct,
...
urlpatterns = [
    ...
    path('product/purchase/offer/<int:id>', ProductPurchase.as_view(), name='product-purchase'),
    ...
    path('product/offer/checkout/<int:id>', ProductCheckout.as_view(), name='product-checkout')
]
