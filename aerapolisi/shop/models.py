...
class Products(models.Model):
    ...
    quantity = models.IntegerField(
        default=0, validators=[MinValueValidator(1, "Quantity must be greater than 0")]
    )
...
class ProductsGallery(models.Model):
    product = models.ForeignKey(
        Products, default=None, on_delete=models.CASCADE, null=True
    )
...
class FavouriteItem(models.Model):
    ...
    favourite = models.ForeignKey(Favourite, on_delete=models.CASCADE, null=True)
...
class OrderInfo(models.Model):
    offer = models.ForeignKey(ProductOffers, on_delete=models.CASCADE, null=True)
...
class ShippingAdress(models.Model):
    order = models.ForeignKey(
        OrderInfo, on_delete=models.CASCADE, blank=True, null=True
    )
...
class OrderRequests(models.Model):
    last_order = models.ForeignKey(
        OrderInfo, on_delete=models.SET_NULL, blank=True, null=True
    )
    number = models.IntegerField(default=0)
    date_requested = models.DateTimeField(auto_now_add=True)
    shipping = models.ForeignKey(
        ShippingAdress, on_delete=models.SET_NULL, blank=True, null=True
    )
